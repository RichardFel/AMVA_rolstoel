...
for file in os.listdir(data_path):
    ...
    try:
        # Shake start
        flip_start = labeled_data.dropna(subset=['Shake start']).iloc[0]
        ...
        end_label = datetime.datetime.strptime(flip_end['Start'], '%H:%M:%S')
    ...
    new_sensor_data = resample_data(
        new_sensor_data, sample_freq, Resample_freq)
